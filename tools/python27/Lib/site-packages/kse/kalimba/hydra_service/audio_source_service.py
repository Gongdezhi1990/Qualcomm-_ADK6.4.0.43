'''
Hydra Audio Data Source Service
'''

from .audio_data_service import HydraAudioDataService
from .constants import SERVICE_TYPE_AUDIO_DATA_SOURCE_SERVICE, DEVICE_TYPE_TESTER


class HydraAudioSource(HydraAudioDataService):
    '''
    Hydra Audio Data Source Service
    ...
    def __init__(self, hydra_protocol, device_type=DEVICE_TYPE_TESTER, service_tag=1,
                 **kwargs):
        ...
        super(HydraAudioSource, self).__init__(
            hydra_protocol,
            SERVICE_TYPE_AUDIO_DATA_SOURCE_SERVICE,
            device_type,
            service_tag,
            **kwargs)
