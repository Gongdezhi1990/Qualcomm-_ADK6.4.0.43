...
Built by $Id: //depot/bg/Releases/ADK/ADK6.4/tools/ANC_tuning_tool/production_line/hydracore/TestEngine.py#1 $
from C API at TestEngine.h
"""
import os
import logging
import ctypes as CT
...
class TestEngine(object):
        ...
        Generated from C API:
            ...
            Example:
                ...
                if (handle != 0)
                {
                    ...
                    if (success == TE_OK)
                    {
                        success = teAudioCloseSource(handle, sinkId);
                    }
        ...
        Generated from C API:
            ...
            Parameters :    handle -
                            ...
                            maxLen -
                                ...
                                of the value array (in bytes), and the output value is the
                                actual length of the key's value. If the given length is
    ...
    def tePsRead(self, handle, keyId, valueLen, value, _readLen=0):
        ...
        Generated from C API:
            ...
            Description :   Used to read the persistent store key specified for user, DSP,
                            connectivity library, and customer PS keys (for audio PS keys
                            use tePsAudioRead).
    ...
    def tePsWrite(self, handle, keyId, valueLen, value):
        ...
        Generated from C API:
            ...
            Description :   Used to write the persistent store key specified for user, DSP,
                            connectivity library and customer PS keys (for audio PS keys
                            use tePsAudioWrite).
                            <p>This function is unsupported for BlueCore and CSRC9xxx ICs
        ...
        Generated from C API:
            ...
            Parameters :    handle -
                            ...
                            readLen -
                                ...
                                <p>If the key has not been written this value will be set to
                                zero.
                                <p>Refer to IC audio firmware documentation for key length
                                limits.
        ...
        Generated from C API:
            ...
            Parameters :    handle -
                            ...
                            valueLen -
                                ...
                                zero causes the key value to be deleted.
                                <p>Refer to IC audio firmware documentation for key length
                                limits.
