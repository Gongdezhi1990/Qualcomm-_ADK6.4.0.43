...
%perl options:'dspinfo_matlab.i -outfile=dspinfo_proto.m'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival);
ThunkLibName=[];
% const kalarchinfo * kalarchinfo_from_arch ( KalimbaArch kal_arch ); 
fcns.name{fcnNum}='kalarchinfo_from_arch'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='kalarchinfoPtr'; fcns.RHS{fcnNum}={'KalimbaArch'};fcnNum=fcnNum+1;
