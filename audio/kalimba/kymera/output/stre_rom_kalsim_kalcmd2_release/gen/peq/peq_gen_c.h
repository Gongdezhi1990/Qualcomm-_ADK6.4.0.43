...
#define PEQ_CONSTANT_CORE_TYPE_Single_precision		0x00000000
#define PEQ_CONSTANT_CORE_TYPE_First_order     		0x00000001
#define PEQ_CONSTANT_CORE_TYPE_Double_precision		0x00000002
