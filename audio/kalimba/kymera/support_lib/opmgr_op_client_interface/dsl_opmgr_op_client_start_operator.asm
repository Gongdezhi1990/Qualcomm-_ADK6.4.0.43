...
.const $_opmgr_op_client_start_operator        PATCH_ENTRY_OPMGR_CLIENT_START_OPERATOR;
#else /* DISABLE_PATCH_BUILD_ID_CHECK */

.MODULE $M.opmgr_op_client_interface.opmgr_op_client_start_operator;
.CODESEGMENT PM;
.MINIM;

$_opmgr_op_client_start_operator:
    rMAC = M[$_patched_fw_version];
    Null = rMAC - PATCH_BUILD_ID;
    if EQ jump  PATCH_ENTRY_OPMGR_CLIENT_START_OPERATOR; 
