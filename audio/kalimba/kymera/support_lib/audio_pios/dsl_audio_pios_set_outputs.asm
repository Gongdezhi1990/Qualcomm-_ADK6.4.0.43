...
.const $_audio_pios_set_outputs    PATCH_ENTRY_AUDIO_PIOS_SET_OUTPUTS;

#else /* DISABLE_PATCH_BUILD_ID_CHECK */

.MODULE $M.download_support_lib.audio_pios_set_outputs;
.CODESEGMENT PM;
.MINIM;

$_audio_pios_set_outputs:
    rMAC = M[$_patched_fw_version];
    Null = rMAC - PATCH_BUILD_ID;
    if EQ jump PATCH_ENTRY_AUDIO_PIOS_SET_OUTPUTS;
