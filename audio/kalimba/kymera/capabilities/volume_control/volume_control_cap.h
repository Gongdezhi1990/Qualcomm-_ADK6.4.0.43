 ...
 * NB. This structure has been deliberately tag-named _exdata as opposed to _data
 *      only in rom_v02 specific branch, to fix a symbol space incompatibility
 *      (see B-279316)
 */
typedef struct vol_ctrl_exdata
{
