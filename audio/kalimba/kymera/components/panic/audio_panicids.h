 ...
 */
    ...
    /**
     * An invalid stream endpoint ID (SID) was seen. This suggests the
     ...
     * released.
     */
    PANIC_IPC_HWSEM_ALREADY_RELEASED = 0x0085,
    ...
    /**
     * Buffer descriptor/flags invalid for the current operation.
     */
    PANIC_AUDIO_BUFFER_DESC_INVALID = 0x009C,

    /**
     * PS was not initialized because the PS file system is not ready.
     */
    PANIC_AUDIO_PS_NOT_INITIALIZED = 0x009D,

    /**
     * P1 panicked. An event has already been reported to the curator
     * containing the panic details.
     */
    PANIC_AUDIO_PX_PANICKED = 0x009E,

    /**
     * ACCMD con_tx_handler could not invoke the tx function for the
     * external connection.
     */
    PANIC_AUDIO_ACCMD_SEND_TO_EXT_CON_FAILED = 0x009F,

    /**
     * Operator client failed to execute a callback.
     */
    PANIC_AUDIO_OP_CLIENT_CALLBACK_FAILED = 0x00A0,

    /**
     * One of the memory heap is in an unexpected state. 
     * It might be due to corrupt memory or unexpected 
     * initialisation sequence.
     */
    PANIC_AUDIO_HEAP_INVALID = 0x00A1,
     ...
     * AOV fsm entered error state.
     */
    PANIC_AUDIO_AOV_OP_RESPOSNE_ERROR = 0x4015,
