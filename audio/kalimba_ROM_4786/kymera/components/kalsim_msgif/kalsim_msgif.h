...
*/
/**
 * kalsim msgif task init message
 */
#define MSGIF_INIT_START 1

/**
 * kalsim msgif accmd messages
 */
#define MSGIF_ACCMD_MSG  2

/**
 * kalsim msgif message to tear down all connections
 */
#define MSGIF_TEAR_DOWN  3
